          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Masukkan Data Parkir</h6>
                </div>
                <div class="card-body">
                    <form action="aksimasuk.php" method="post" enctype="multipart/form-data">
                        <!-- License Plate -->
                        <div class="form-group">
                            <label for="No_plat">Nomor Plat:</label>
                            <input type="text" class="form-control" id="No_plat" name="NoPlat" required>
                        </div>
        
                        <!-- Entry Time -->
                        <div class="form-group">
                            <label for="Waktu_masuk">Waktu Masuk:</label>
                            <input type="text" class="form-control" id="Waktu_masuk" name="WaktuMasuk" readonly>
                        </div>                
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="merek" name="merek" required>
                                ...
                                <option value="DLL">DLL (dan lain-lain)</option>
                            </select>
                        </div>                
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="keterangan[]" multiple>
                        </div>                
            ...
            <!-- Script to set entry time to current system time and update continuously -->
            <script>
                function updateWaktuMasuk() {
                    ...
                    document.getElementById('Waktu_masuk').value = formattedDateTime;
                }
                
                // Set the default date and time when the page loads
                updateWaktuMasuk();
                
                // Update entry time every second
                setInterval(updateWaktuMasuk, 1000);
            </script>
        </div>
...
$(document).ready(function () {
  $("form").submit(function (e) {
    ...
    // Simulasi AJAX request (ganti dengan sesuai kebutuhan)
    $.ajax({
      type: "POST",
      url: "aksimasuk.php",
      data: $(this).serialize(),
    ...
    // Setelah berhasil, tampilkan SweetAlert
    Swal.fire({
      icon: 'success',
      title: 'Sukses!',
      text: 'Data berhasil disubmit.',
    }).then((result) => {
      // Submit the form to the server after SweetAlert is closed
